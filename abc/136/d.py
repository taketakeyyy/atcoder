...
* even_num は最終的に折返し地点に収束する
* odd_num は最終的に折返し地点の1つ左側に収束する

ことがわかります。

次にLグループについて考えます。

一番右のLグループに着目すると、Rグループのときと同様の考察でcnt, even_num, odd_num を求めて、

* even_numは最終的に折返し地点に収束する
* odd_numは最終的に折返し地点の1つ右側に収束する
